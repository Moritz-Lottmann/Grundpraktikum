...
calc('A ', 5.995, 881.5, 5.2)
calc('B ', 4.49, 370.7, 8.9)
calc('C ', 4.48, 261.2, 11.1)
calc('D1', 2.99, 109.8, 19)
'calc('D2', 2.98, 1, 16.5)
calc('D3', 2.985, 110.5, 16.6)
calc('D4', 2.98, 111.4, 16.4)
calc('D5', 2.99, 110.4, 16.6)
calc('D6', 2.99, 109.9, 16.5)
calc('E ', 1.992, 63.7, 23.6)
calc('F ', 0.995, 13.9, 62.6)'''
